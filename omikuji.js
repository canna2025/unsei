function drawOmikuji() {
    // おみくじの結果とその確率（重み）
    const results = [
        { text: "大吉: とても良いことがあるでしょう！", weight: 1 },   // 1: 1回に1回の確率
        { text: "中吉: 少し良いことがありそう！", weight: 3 },   // 3: 1回に3回の確率
        { text: "小吉: ちょっとした良いことがあるかも！", weight: 5 },   // 5: 1回に5回の確率
        { text: "末吉: 少しだけ良いことがあるかもしれません。", weight: 10 },   // 10: 1回に10回の確率
        { text: "凶: 少し気をつけて。心を落ち着けて行動しましょう。", weight: 2 },   // 2: 1回に2回の確率
        { text: "大凶: 今は少し休んで、気持ちを落ち着けましょう。", weight: 1 }    // 1: 1回に1回の確率
    ];
